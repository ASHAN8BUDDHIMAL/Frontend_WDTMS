      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-md mx-auto relative">
            ...
            />
            <svg className="w-5 h-5 absolute right-6 top-3.5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          ...
          {servicesData.filter(s => s.popular).map((service, index) => (
            <button
              key={index}
              className="px-4 py-2 bg-white border border-gray-200 rounded-full shadow-sm hover:bg-gray-50 transition"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredServices.map((section, index) => (
            <div
              key={index}
              className={`bg-gradient-to-br ${section.color} ${section.hoverColor} p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer`}
